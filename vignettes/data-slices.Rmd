...
* `evenly(x, ..., lower = 5, upper = 10)` --- either of the two above uses of `evenly()` will use the lower and upper limits of the vector `x`. Arguments `lower` and `upper` are be used to change one or both of the upper or lower bounds.
