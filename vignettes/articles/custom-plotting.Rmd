...
{gratia} provides high-level functions like `draw()` to get you a good graphical overview of a fitted model, but with little option for customisation --- it isn't possible or desirable to allow all possible customisation options and features of {ggplot2} through a single function. Think about how many arguments that would require!
